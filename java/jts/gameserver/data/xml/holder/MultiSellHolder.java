...
import jts.gameserver.model.base.MultiSellEntry;
import jts.gameserver.model.base.MultiSellIngredient;
import jts.gameserver.model.items.ItemInstance;
import jts.gameserver.network.serverpackets.MultiSellList;
import jts.gameserver.network.serverpackets.components.CustomMessage;
import jts.gameserver.scripts.Functions;
import jts.gameserver.templates.item.ItemTemplate;
import jts.gameserver.utils.XMLUtil;
...
public class MultiSellHolder
{
	...
	{
		if(Config.ALT_DISABLED_MULTISELL[0] != 0)
		...
		if(player.isGM())
			Functions.sendDebugMessage(player, "MULTISELL: " + listId + ".xml " + (player.isLangRus() ? "Налог: " : "Tax: ") + taxRate + "%");
	}
