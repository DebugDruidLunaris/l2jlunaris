...
public class AccountPointsDAO
{
	...
	public static final String SELECT_SQL_QUERY = "SELECT points FROM " + Config.LOGIN_DB + ".accounts WHERE login=?";
	public static final String UPDATE_SQL_QUERY = "UPDATE " + Config.LOGIN_DB + ".accounts SET points=? WHERE login=?";
