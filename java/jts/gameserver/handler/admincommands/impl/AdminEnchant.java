...
public class AdminEnchant implements IAdminCommandHandler
{
	...
	private void setEnchant(Player activeChar, int ench, int armorType)
	{
		...
		if(itemInstance != null)
		{
			...
			Log_New.LogEvent(activeChar.getName(), activeChar.getIP(), "AdminCommands", new String[] { "Enchant Changed enchantment of  : " +target+ "'s " + itemInstance.getName() + " from " + curEnchant+ " to " + ench + "."});
