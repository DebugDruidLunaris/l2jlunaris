...
import jts.gameserver.network.serverpackets.ExRedSky;
...
public class CursedWeapon
{
	...
	private int _itemId, _skillMaxLevel;
	...
	public void giveSkillAndUpdateStats()
	{
		...
		// Запишем обновление в лог.
		CursedWeaponsManager._log.info(String.format("Player (%s, %d) stats and skills with cursed weapon updated (%d)", player.getName(), player.getStoredId(), getItemId()));
	}
