...
import jts.gameserver.instancemanager.AutoSpawnManager.AutoSpawnInstance;
...
public class SevenSigns
{
	...
	public SevenSigns()
	{
		...
		if(Config.ALT_SS_ANNOUNCE_PERIOD > 0)
			ThreadPoolManager.getInstance().schedule(new SevenSignsAnnounce(), Config.ALT_SS_ANNOUNCE_PERIOD * 1000L * 60);
	}
