		...
		if(!checkPlayer())
		{
			...
			else
			{
				if(player.isLogoutStarted())
					Log.add("Olympiad : " + _name + " crashed coz player.isLogoutStarted()", "olympiad");
				if(!player.isOnline())
					Log.add("Olympiad : " + _name + " crashed coz !player.isOnline()", "olympiad");
				if(!player.isConnected())
					Log.add("Olympiad : " + _name + " crashed coz !player.isOnline()", "olympiad");
				if(player.getOlympiadGame() == null)
					Log.add("Olympiad : " + _name + " crashed coz player.getOlympiadGame() == null", "olympiad");
				if(player.getOlympiadObserveGame() != null)
					Log.add("Olympiad : " + _name + " crashed coz player.getOlympiadObserveGame() != null", "olympiad");
			}
		}
	}
