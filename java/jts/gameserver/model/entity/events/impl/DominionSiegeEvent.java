...
import jts.gameserver.dao.DominionRewardDAO;
...
import jts.gameserver.network.serverpackets.ExDominionWarEnd;
...
public class DominionSiegeEvent extends SiegeEvent<Dominion, SiegeClanObject>
{
	...
	{
		DominionSiegeEvent eventTarget = target.getEvent(DominionSiegeEvent.class);
		DominionSiegeEvent eventAttacker = attacker.getEvent(DominionSiegeEvent.class);

		// своих во время ТВ бить нельзя 
		if(eventTarget == eventAttacker)
