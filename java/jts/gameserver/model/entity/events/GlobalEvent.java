...
import jts.gameserver.listener.event.OnStartStopListener;
...
import jts.gameserver.model.entity.events.objects.InitableObject;
import jts.gameserver.model.entity.events.objects.SpawnableObject;
	...
	public void giveItem(Player player, int itemId, long count)
	{
		switch(itemId)
		{
			case ItemTemplate.ITEM_ID_FAME:
				if(player.hasBonus())
					count = (long) (count * Config.RATE_SIEGE_FAME_FOR_PREMIUM);
