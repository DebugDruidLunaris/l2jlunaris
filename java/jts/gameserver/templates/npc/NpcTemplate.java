package jts.gameserver.templates.npc;
...
public final class NpcTemplate extends CharTemplate
{
	...
	private void setType(String type)
	{
		...
		try
		{
			classType = (Class<NpcInstance>) Class.forName("jts.gameserver.model.instances." + type + "Instance");
		}
	...
	private void setAI(String ai)
	{
		...
		try
		{
			classAI = (Class<CharacterAI>) Class.forName("jts.gameserver.ai." + ai);
		}
		catch(ClassNotFoundException e)
		{
