...
public abstract class ItemTemplate extends StatTemplate
{
	...
	public static final int[] ITEM_ID_FORMAL_WEAR = Config.Item_Custom_Template;
	...
	private final boolean _mage_weapon;
	...
	protected ItemTemplate(final StatsSet set)
	{
		...
		_mage_weapon = set.getBool("is_magic_weapon", false);
