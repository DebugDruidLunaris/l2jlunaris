	...
	protected void runImpl()
	{
		...
		switch(_type)
		{
			case NORMAL:
				...
				Log_New.LogEvent(player.getName(), "Skills", "SkillGetNormal", new String[] { "char: " + player.getName() + " learned skill " + skillLearn.getId() + " level: " + skillLearn.getLevel() + " for " + skillLearn.getCost() + "" });
				if(trainer != null)
					trainer.showSkillList(player);
				break;
			case TRANSFORMATION:
				learnSimpleNextLevel(player, skillLearn, skill);
				Log_New.LogEvent(player.getName(), "Skills", "SkillGetTransformation", new String[] { "char: " + player.getName() + " learned skill " + skillLearn.getId() + " level: " + skillLearn.getLevel() + " for " + skillLearn.getCost() + "" });
				if(trainer != null)
					trainer.showTransformationSkillList(player, AcquireType.TRANSFORMATION);
				break;
			case COLLECTION:
				learnSimpleNextLevel(player, skillLearn, skill);
				Log_New.LogEvent(player.getName(), "Skills", "SkillGetCollection", new String[] { "char: " + player.getName() + " learned skill " + skillLearn.getId() + " level: " + skillLearn.getLevel() + " for " + skillLearn.getCost() + "" });
				if(trainer != null)
			...
			case TRANSFER_SHILLIEN_SAINTS:
				...
				Log_New.LogEvent(player.getName(), "Skills", "SkillGetTransfer", new String[] { "char: " + player.getName() + " learned skill " + skillLearn.getId() + " level: " + skillLearn.getLevel() + " for " + skillLearn.getCost() + "" });
				if(trainer != null)
					trainer.showTransferSkillList(player);
				break;
			case FISHING:
				learnSimpleNextLevel(player, skillLearn, skill);
				Log_New.LogEvent(player.getName(), "Skills", "SkillGetFishing", new String[] { "char: " + player.getName() + " learned skill " + skillLearn.getId() + " level: " + skillLearn.getLevel() + " for " + skillLearn.getCost() + "" });
				if(trainer != null)
					NpcInstance.showFishingSkillList(player);
				break;
			case CLAN:
				learnClanSkill(player, skillLearn, trainer, skill);
				Log_New.LogEvent(player.getName(), "Skills", "SkillGetClan", new String[] { "char: " + player.getName() + " learned skill " + skillLearn.getId() + " level: " + skillLearn.getLevel() + " for " + skillLearn.getCost() + "" });
				break;
			case SUB_UNIT:
				learnSubUnitSkill(player, skillLearn, trainer, skill, _subUnit);
				Log_New.LogEvent(player.getName(), "Skills", "SkillGetSubUnit", new String[] { "char: " + player.getName() + " learned skill " + skillLearn.getId() + " level: " + skillLearn.getLevel() + " for " + skillLearn.getCost() + "" });
				break;
			case CERTIFICATION:
				...
				learnSimpleNextLevel(player, skillLearn, skill);
				Log_New.LogEvent(player.getName(), "Skills", "SkillGetCertification", new String[] { "char: " + player.getName() + " learned skill " + skillLearn.getId() + " level: " + skillLearn.getLevel() + " for " + skillLearn.getCost() + "" });
				if(trainer != null)
