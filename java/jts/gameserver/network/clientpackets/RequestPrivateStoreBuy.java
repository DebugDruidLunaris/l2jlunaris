		...
		finally
		{
			try
			{
				...
				for(TradeItem bi : buyList)
				{
					...
					Log_New.LogEvent(seller.getName(), seller.getIP(), "PrivateStore", new String[] { "Sold Item:", "" + item.getName() + " count: " + item.getCount() + " objId: " + item.getObjectId() + " to " + buyer.getName() + "" });
					Log_New.LogEvent(buyer.getName(), buyer.getIP(), "PrivateStore", new String[] { "Bought Item:", "" + item.getName() + " count: " + item.getCount() + " objId: " + item.getObjectId() + " from " + seller.getName() + "" });
