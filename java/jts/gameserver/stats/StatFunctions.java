...
public class StatFunctions
{
	...
	private static class FuncRunSpdLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_MOVE, env.value);
		}
	}
	...
	private static class FuncPDefLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_PDEF, env.value);
		}
	}
	...
	private static class FuncMDefLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_MDEF, env.value);
		}
	}
	...
	private static class FuncPAtkLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_PATK, env.value);
		}
	}
	...
	private static class FuncMAtkLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_MATK, env.value);
		}
	}
	...
	private static class FuncPAtkSpdLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_PATK_SPD, env.value);
		}
	}
	...
	private static class FuncMAtkSpdLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_MATK_SPD, env.value);
		}
	}
	...
	private static class FuncCAtkLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_CRIT_DAM / 2., env.value);
		}
	}
	...
	private static class FuncEvasionLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_EVASION, env.value);
		}
	}
	...
	private static class FuncAccuracyLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_ACCURACY, env.value);
		}
	}
	...
	private static class FuncCritLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_CRIT, env.value);
		}
	}
	...
	private static class FuncMCritLimit extends Func
	{
		...
		public void calc(Env env)
		{
			env.value = Math.min(Config.FORMULA_LIM_MCRIT, env.value);
		}
	}
