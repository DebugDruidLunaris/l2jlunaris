...
public class PetDataTable
{
	...
	public static final int SUPER_FELINE_QUEEN_Z_ID = 1601;
	public static final int SUPER_KAT_THE_CAT_Z_ID = 1602;
	public static final int SUPER_MEW_THE_CAT_Z_ID = 1603;
	...
	public static enum L2Pet
	{
		...
		Baby_Rudolph(Baby_Rudolph_ID, 20761, 20769, false, 1, 12, .30, 2, 2),
		Baby_Rudolph_2(Baby_Rudolph_ID, 20760, 20769, false, 1, 12, .30, 2, 2),
		...
		SUPER_FELINE_QUEEN_Z(SUPER_FELINE_QUEEN_Z_ID, 21917, Config.VITAMIN_PETS_FOOD_ID, false, 55, 12, .3, 2, 2),
		SUPER_KAT_THE_CAT_Z(SUPER_KAT_THE_CAT_Z_ID, 21916, Config.VITAMIN_PETS_FOOD_ID, false, 55, 12, .3, 2, 2),
		SUPER_MEW_THE_CAT_Z(SUPER_MEW_THE_CAT_Z_ID, 21918,  Config.VITAMIN_PETS_FOOD_ID, false, 55, 12, .3, 2, 2);

		private final int _npcId;
		private final int _controlItemId;
		private final int _foodId;
		private final boolean _isMountable;
		private final int _minLevel; // Уровень, ниже которого не может
		// опускаться пет
		private final int _addFed; // На сколько процентов увеличивается полоска
		// еды, при кормлении
	...
	public static boolean isRudolph(int id)
	{
		return id == Baby_Rudolph_ID;
	}
