...
public class SoIManager
{
    ...
    private static final long SOI_OPEN_TIME = Config.SOI_OPEN_TIME * 60 * 60 * 1000L;
    ...
    public static void notifyCohemenesKill()
    {
        ...
        {
            if (getCohemenesCount() < Config.COHEMENES_KILLS_FOR_SOI - 1)
            {
    ...
    public static void notifyEkimusKill()
    {
        ...
        {
            if (getEkimusCount() < Config.EKIMUS_KILLS_FOR_SOI - 1)
            {
    ...
    public static void notifyHoEDefSuccess() 
    {
        ...
        {
            if (getHoEDefCount() < Config.HALL_OF_ERROSION_DEF_COUNT - 1)
            {
