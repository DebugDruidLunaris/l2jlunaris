...
public class LotteryManager
{
	...
	{
		protected startLottery() {} // Do nothing
	...
	private void announceLottery()
	{
		...
		Announcements.getInstance().announceToAll("Лотерейные билеты теперь доступны для счастливого лотерейного #" + getId() + ".");
	}
	...
	{
		protected stopSellingTickets() {} // Do nothing
	...
	{
		protected finishLottery() {} // Do nothing
