...
public final class AutoBan
{
	...
	public static boolean ChatBan(String actor, int period, String msg, String GM)
	{
		...
		if(plyr != null)
		{
			...
			plyr.sendMessage(new CustomMessage("jts.Util.AutoBan.ChatBan", plyr).addString(GM).addNumber(period));
	...
	public static boolean ChatUnBan(String actor, String GM)
	{
		...
		if(plyr != null)
		{
			plyr.sendMessage(new CustomMessage("jts.Util.AutoBan.ChatUnBan", plyr).addString(GM));
