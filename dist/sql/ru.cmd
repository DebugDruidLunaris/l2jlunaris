...
echo.
echo Вас приветствует мастер установки сервера.
echo Этот мастер поможет Вам установить базу данных сервера.
...
echo ======================================================================
set DO_INSTALL=Y
set /P DO_INSTALL=Установить сервер авторизации [Y/n]
...
set /P DB_HOST=Адрес сервера базы данных [%DB_HOST%]:

set /P DB_USER=Пользователь базы данных [%DB_USER%]:

set /P DB_PASSWORD=Пароль пользователя баз данных [%DB_USER%]:
...
goto install
:dberror
echo ! Не могу подключится к базе данных. Проверьте правильность указанных параметров!
goto step2
...
if "%ANSWER%"=="N" goto step1
echo  - Устанавливаем базу данных, подождите...
