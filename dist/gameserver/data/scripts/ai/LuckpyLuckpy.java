...
public class LuckpyLuckpy extends DefaultAI
{
	...
	public LuckpyLuckpy(NpcInstance actor)
	{
		super(actor);
	}
	...
	protected void onEvtArrived()
	{
		...
		if(_nextEat < System.currentTimeMillis())
		{
			...
			if(closestItem != null && closestItem.getCount() >= Config.ALT_MIN_ADENA_TO_EAT)
			{
				...
				if(i_ai2 == 2 && getFirstSpawned(actor))
				{
					...
					actor.doDie(actor);
					actor.deleteMe();
					addTimer(1500, 0, null, Config.ALT_TIME_IF_NOT_FEED * 60000);
				}

				i_ai2++;

				_nextEat = System.currentTimeMillis() + Config.ALT_INTERVAL_EATING * 1000;
			}

			else if(closestItem != null && closestItem.getCount() < Config.ALT_MIN_ADENA_TO_EAT && !_firstSaid)
			{
				Functions.npcSay(actor, "Что это вообще? Я хочу больше !!! Я не буду есть меньше " + Config.ALT_MIN_ADENA_TO_EAT + " Адены!!!");
				_firstSaid = true;
			}
		}
	}
	...
	protected void onEvtTimer(int timerId, Object arg1, Object arg2)
	{
		...
		if(timerId == 1500)
		{
			...
			{
				prev_st = i_ai2;
				addTimer(1500, Config.ALT_TIME_IF_NOT_FEED * 60000);
			}
