...
public class Baylor extends DefaultAI
{
	...
	protected void onEvtSeeSpell(Skill skill, Creature caster)
	{
		...
		if(_claw_count >= count)
		{
			...
			Functions.npcSayCustomMessage(getActor(), "scripts.ai.Baylor.1");
		}
	}
	...
	protected boolean createNewTask()
	{
		...
		if(actor_hp_precent < 30 && !_isUsedInvincible)
		{
			...
			Functions.npcSayCustomMessage(getActor(), "scripts.ai.Baylor.2");
			return true;
		}
		...
		if(rnd_per < 7 && actor.getEffectList().getEffectsBySkill(Berserk) == null)
		{
			...
			Functions.npcSayCustomMessage(getActor(), "scripts.ai.Baylor.3");
			return true;
		}
