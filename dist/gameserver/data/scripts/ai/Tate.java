			...
			if(!wait)
				switch(current_point)
				{
					case 0:
						...
						Functions.npcSayCustomMessage(getActor(), "scripts.ai.Tate.1");
						wait = true;
						return true;
					case 7:
						wait_timeout = System.currentTimeMillis() + 15000;
						Functions.npcSayCustomMessage(getActor(), "scripts.ai.Tate.2");
						wait = true;
						return true;
					case 11:
						wait_timeout = System.currentTimeMillis() + 30000;
						Functions.npcSayCustomMessage(getActor(), "scripts.ai.Tate.3");
						wait = true;
						return true;
				}
