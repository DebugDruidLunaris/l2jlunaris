...
public class _103_SpiritOfCraftsman extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == 30307 && st.getCond() == 0)
		{
			...
			if(npcId == 30307 && st.getCond() >= 1 && (st.ownItemCount(KAROYDS_LETTER_ID) >= 1 || st.ownItemCount(CECKTINONS_VOUCHER1_ID) >= 1 || st.ownItemCount(CECKTINONS_VOUCHER2_ID) >= 1))
				htmltext = "blacksmith_karoyd_q0103_06.htm";
			else if(npcId == 30132 && st.getCond() == 1 && st.ownItemCount(KAROYDS_LETTER_ID) == 1)
			{
			...
			else if(npcId == 30132 && st.getCond() >= 2 && (st.ownItemCount(CECKTINONS_VOUCHER1_ID) >= 1 || st.ownItemCount(CECKTINONS_VOUCHER2_ID) >= 1))
				htmltext = "cecon_q0103_02.htm";
			else if(npcId == 30144 && st.getCond() == 2 && st.ownItemCount(CECKTINONS_VOUCHER1_ID) >= 1)
			{
			...
			else if(npcId == 30144 && st.getCond() == 3 && st.ownItemCount(CECKTINONS_VOUCHER2_ID) >= 1 && st.ownItemCount(BONE_FRAGMENT1_ID) < 10)
				htmltext = "harne_q0103_02.htm";
			else if(npcId == 30144 && st.getCond() == 4 && st.ownItemCount(CECKTINONS_VOUCHER2_ID) == 1 && st.ownItemCount(BONE_FRAGMENT1_ID) >= 10)
			{
			...
			else if(npcId == 30144 && st.getCond() == 5 && st.ownItemCount(SOUL_CATCHER_ID) == 1)
				htmltext = "harne_q0103_04.htm";
			else if(npcId == 30132 && st.getCond() == 5 && st.ownItemCount(SOUL_CATCHER_ID) == 1)
			{
			...
			else if(npcId == 30132 && st.getCond() == 6 && st.ownItemCount(PRESERVE_OIL_ID) == 1 && st.ownItemCount(ZOMBIE_HEAD_ID) == 0 && st.ownItemCount(STEELBENDERS_HEAD_ID) == 0)
				htmltext = "cecon_q0103_04.htm";
			else if(npcId == 30132 && st.getCond() == 7 && st.ownItemCount(ZOMBIE_HEAD_ID) == 1)
			{
			...
			else if(npcId == 30132 && st.getCond() == 8 && st.ownItemCount(STEELBENDERS_HEAD_ID) == 1)
				htmltext = "cecon_q0103_06.htm";
			else if(npcId == 30307 && st.getCond() == 8 && st.ownItemCount(STEELBENDERS_HEAD_ID) == 1)
			{
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		{
			if(st.ownItemCount(CECKTINONS_VOUCHER2_ID) == 1 && st.ownItemCount(BONE_FRAGMENT1_ID) < 10)
				if(Rnd.chance(33))
				{
					st.giveItems(BONE_FRAGMENT1_ID, 1);
					if(st.ownItemCount(BONE_FRAGMENT1_ID) == 10)
					{
			...
			if(st.ownItemCount(PRESERVE_OIL_ID) == 1)
				if(Rnd.chance(33))
				{
