 ...
 * @author Magister
 */
public class _637_ThroughTheGateOnceMore extends Quest implements ScriptFile
{
	// npc
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		switch(id)
		{
			case CREATED:
				if(npcId == falsepriest_flauron)
					if(st.getPlayer().getLevel() >= 73 && st.ownItemCount(q_faded_mark_of_sac) >= 1 && st.ownItemCount(q_mark_of_heresy) == 0)
