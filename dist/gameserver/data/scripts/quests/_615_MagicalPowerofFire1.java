			...
			case NARAN:
				if(cond == 0)
					if(st.getPlayer().getLevel() >= 74)
						if(st.ownItemCount(MARK_OF_VARKA_ALLIANCE1) == 1 || st.ownItemCount(MARK_OF_VARKA_ALLIANCE2) == 1 || st.ownItemCount(MARK_OF_VARKA_ALLIANCE3) == 1 || st.ownItemCount(MARK_OF_VARKA_ALLIANCE4) == 1 || st.ownItemCount(MARK_OF_VARKA_ALLIANCE5) == 1)
						{
