...
public class _647_InfluxOfMachines extends Quest implements ScriptFile
{
	...
	// REWARDS
	private static final int[] RECIPES = { 6887, 6881, 6897, 7580, 6883, 6899, 6891, 6885, 6893, 6895 };
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("quest_accept"))
		{
			...
			if(st.ownItemCount(BROKEN_GOLEM_FRAGMENT) >= 500)
			{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		int cond = st.getCond();
		long count = st.ownItemCount(BROKEN_GOLEM_FRAGMENT);
		if(cond == 0)
