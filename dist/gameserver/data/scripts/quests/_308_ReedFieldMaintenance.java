...
public class _308_ReedFieldMaintenance extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		QuestState qs_238 = st.getPlayer().getQuestState(_238_SuccessFailureOfBusiness.class);
		...
		if(npcId == contract_worker)
			...
			{
				if(GetMemoState == 1 && st.ownItemCount(q308_leather_of_murcrokian1) + st.ownItemCount(q308_leather_of_murcrokian2) >= 1 && !qs_238.isCompleted())
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		QuestState qs_309 = st.getPlayer().getQuestState(_309_ForAGoodCause.class);
		int GetMemoState = st.getInt("improving_field_of_reeds");
		int npcId = npc.getNpcId();
		int id = st.getState();
