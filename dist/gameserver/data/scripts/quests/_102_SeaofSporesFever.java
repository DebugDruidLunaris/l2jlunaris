...
public class _102_SeaofSporesFever extends Quest implements ScriptFile
{
	...
	{
		if(st.ownItemCount(COBS_MEDICINE2) == 0 && st.ownItemCount(COBS_MEDICINE3) == 0 && st.ownItemCount(COBS_MEDICINE4) == 0 && st.ownItemCount(COBS_MEDICINE5) == 0)
			st.setCond(6);
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == 30284)
		{
			...
			else if(cond == 1 && st.ownItemCount(ALBERRYUS_LETTER) == 1)
				htmltext = "alberryus_q0102_03.htm";
			else if(cond == 2 && st.ownItemCount(EVERGREEN_AMULET) == 1)
				htmltext = "alberryus_q0102_09.htm";
			else if(cond == 4 && st.ownItemCount(COBS_MEDICINE1) == 1)
			{
				st.setCond(5);
			...
			else if(cond == 6 && st.ownItemCount(ALBERRYUS_LIST) == 1)
			{
		...
		{
			if(cond == 1 && st.ownItemCount(ALBERRYUS_LETTER) == 1)
			{
			...
			else if(cond == 2 && st.ownItemCount(EVERGREEN_AMULET) > 0 && st.ownItemCount(DRYAD_TEARS) < 10)
				htmltext = "cob_q0102_04.htm";
			else if(cond > 3 && st.ownItemCount(ALBERRYUS_LIST) > 0)
				htmltext = "cob_q0102_07.htm";
			else if(cond == 3 && st.ownItemCount(EVERGREEN_AMULET) > 0 && st.ownItemCount(DRYAD_TEARS) >= 10)
			{
		...
		else if(npcId == 30217 && cond == 5 && st.ownItemCount(ALBERRYUS_LIST) == 1 && st.ownItemCount(COBS_MEDICINE2) == 1)
		{
			st.takeItems(COBS_MEDICINE2, 1);
			htmltext = "sentinel_berryos_q0102_01.htm";
			check(st);
		}
		else if(npcId == 30219 && cond == 5 && st.ownItemCount(ALBERRYUS_LIST) == 1 && st.ownItemCount(COBS_MEDICINE3) == 1)
		{
			st.takeItems(COBS_MEDICINE3, 1);
			htmltext = "sentinel_veltress_q0102_01.htm";
			check(st);
		}
		else if(npcId == 30221 && cond == 5 && st.ownItemCount(ALBERRYUS_LIST) == 1 && st.ownItemCount(COBS_MEDICINE4) == 1)
		{
			st.takeItems(COBS_MEDICINE4, 1);
			htmltext = "sentinel_rayjien_q0102_01.htm";
			check(st);
		}
		else if(npcId == 30285 && cond == 5 && st.ownItemCount(ALBERRYUS_LIST) == 1 && st.ownItemCount(COBS_MEDICINE5) == 1)
		{
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if((npcId == 20013 || npcId == 20019) && Rnd.chance(33))
			if(st.ownItemCount(EVERGREEN_AMULET) > 0 && st.ownItemCount(DRYAD_TEARS) < 10)
			{
