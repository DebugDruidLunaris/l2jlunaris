 ...
 * @author Magister
 */
public final class _691_MatrasSuspiciousRequest extends Quest implements ScriptFile
{
	// npc
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("reply_2"))
		{
			if(GetMemoState == 1)
			{
				...
				htmltext = HtmCache.getInstance().getNotNull("quests/_691_MatrasSuspiciousRequest/matras_q0691_08.htm", st.getPlayer());
		...
		else if(event.equalsIgnoreCase("reply_3"))
		{
			if(GetMemoState == 1)
				...
				{
					htmltext = HtmCache.getInstance().getNotNull("quests/_691_MatrasSuspiciousRequest/matras_q0691_10.htm", st.getPlayer());
			...
			case STARTED:
				if(npcId == matras)
					if(GetMemoState == 1)
						...
						{
							htmltext = HtmCache.getInstance().getNotNull("quests/_691_MatrasSuspiciousRequest/matras_q0691_07.htm", st.getPlayer());
							htmltext = htmltext.replace("<?itemcount?>", String.valueOf(GetMemoStateEx));
						}
				break;
		}
