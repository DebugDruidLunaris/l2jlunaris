...
public class _281_HeadForTheHills extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			st.giveItems(ADENA_ID, st.ownItemCount(HillsOfGoldMonsterClaw) * 50, false);
		...
		{
			if(st.ownItemCount(HillsOfGoldMonsterClaw) >= 50)
			{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Marcela)
			...
			else if(cond == 1 && st.ownItemCount(HillsOfGoldMonsterClaw) > 0)
