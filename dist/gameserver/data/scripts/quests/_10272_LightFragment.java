...
public class _10272_LightFragment extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			if(st.ownItemCount(DestroyedLightFragmentPowder) >= 100)
			{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == Artius)
		{
			...
			{
				if(st.ownItemCount(DestroyedDarknessFragmentPowder) >= 100)
		...
		else if(npcId == Lelikia)
		{
			...
			if(cond == 7 && st.ownItemCount(DestroyedLightFragmentPowder) >= 100)
