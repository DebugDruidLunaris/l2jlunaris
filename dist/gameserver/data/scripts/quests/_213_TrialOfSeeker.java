...
public class _213_TrialOfSeeker extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Dufner)
		{
			if(st.ownItemCount(MarkofSeeker) != 0)
			{
				htmltext = "completed";
				st.exitQuest(true);
			}
			else if(cond == 0 && st.ownItemCount(TerrysReport) == 0)
			{
			...
			else if(st.ownItemCount(DufnersLetter) == 1 && st.ownItemCount(TerrysReport) == 0)
				htmltext = "dufner_q0213_06.htm";
			else if(st.ownItemCount(DufnersLetter) == 0 && st.ownItemCount(TerrysReport) == 0)
				htmltext = "dufner_q0213_07.htm";
			else if(st.ownItemCount(TerrysReport) != 0)
			{
		...
		else if(npcId == Terry)
		{
			...
			else if(cond == 3 && st.ownItemCount(MysteriousRunestone) == 0)
			{
				htmltext = "terry_q0213_04.htm";
				st.setCond(2);
			}
			...
			else if(cond == 5 && st.ownItemCount(OlMahumRunestone) != 0 && st.ownItemCount(TurekRunestone) != 0 && st.ownItemCount(AntRunestone) != 0 && st.ownItemCount(TurakBugbearRunestone) != 0)
			...
			else if(cond == 14 && st.ownItemCount(AnalysisResult) > 0)
				htmltext = "terry_q0213_15.htm";
			else if((cond == 14 || cond == 15) && st.ownItemCount(Terrys3rdOrder) > 0)
			{
				if(st.getPlayer().getLevel() < 36)
				...
				if(st.ownItemCount(AbyssRunestone1) != 0 && st.ownItemCount(AbyssRunestone2) != 0 && st.ownItemCount(AbyssRunestone3) != 0 && st.ownItemCount(AbyssRunestone4) != 0)
				{
		...
		else if(npcId == Viktor)
		{
			...
			else if(cond == 10 && st.ownItemCount(MedusaScales) >= 10)
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(cond == 4 && st.ownItemCount(OlMahumRunestone) != 0 && st.ownItemCount(TurekRunestone) != 0 && st.ownItemCount(AntRunestone) != 0 && st.ownItemCount(TurakBugbearRunestone) != 0)
		{
			st.setCond(5);
			st.setState(STARTED);
		}
		else if(cond == 16 && st.ownItemCount(AbyssRunestone1) != 0 && st.ownItemCount(AbyssRunestone2) != 0 && st.ownItemCount(AbyssRunestone3) != 0 && st.ownItemCount(AbyssRunestone4) != 0)
		{
			st.setCond(17);
			st.setState(STARTED);
		}
