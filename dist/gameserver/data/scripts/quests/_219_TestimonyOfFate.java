...
public class _219_TestimonyOfFate extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = {
			{ 6, 0, Medusa, IxiasList, MedusasIchor, 10, 100, 1 },
			{ 6, 0, MarshSpider, IxiasList, MarshSpiderFluids, 10, 100, 1 },
			{ 6, 0, DeadSeeker, IxiasList, DeadSeekerDung, 10, 100, 1 },
			{ 6, 0, Tyrant, IxiasList, TyrantsBlood, 10, 100, 1 },
			{ 6, 0, TyrantKingpin, IxiasList, TyrantsBlood, 10, 100, 1 },
			{ 6, 0, MarshStakatoWorker, IxiasList, NightshadeRoot, 10, 100, 1 },
			{ 6, 0, MarshStakato, IxiasList, NightshadeRoot, 10, 100, 1 },
			{ 6, 0, MarshStakatoSoldier, IxiasList, NightshadeRoot, 10, 100, 1 },
			{ 6, 0, MarshStakatoDrone, IxiasList, NightshadeRoot, 10, 100, 1 },
