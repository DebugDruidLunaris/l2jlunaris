...
public class _214_TrialOfScholar extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			if(st.ownItemCount(Sylvains_Letter) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Marias_2nd_Letter) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Cretas_1st_Letter) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Lucillas_Handbag) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Cretas_Painting2) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Cretas_Painting3) == 0 || st.ownItemCount(Brown_Scroll_Scrap) < 5)
				return null;
		...
		else if(event.equalsIgnoreCase("valkon_q0214_04.htm") && _state == STARTED && st.ownItemCount(Valkons_Request) == 0)
		{
			st.soundEffect(SOUND_MIDDLE);
			st.giveItems(Valkons_Request, 1);
		}
		else if(event.equalsIgnoreCase("jurek_q0214_03.htm") && _state == STARTED && st.ownItemCount(Grand_Magisters_Sigil) == 0 && st.ownItemCount(Symbol_of_Jurek) == 0)
		{
			st.soundEffect(SOUND_MIDDLE);
		...
		{
			if(st.ownItemCount(Miriens_2nd_Sigil) == 0 || st.ownItemCount(Symbol_of_Jurek) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Cronos_Letter) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Dieters_Key) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Cretas_2nd_Letter) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Dieters_Letter) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Rauts_Letter_Envelope) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Strong_Liquor) == 0)
				return null;
		...
		{
			if(st.ownItemCount(Casians_List) == 0)
			{
				st.soundEffect(SOUND_MIDDLE);
		...
		{
			if(st.ownItemCount(Scripture_Chapter_1) == 0)
				return null;
			if(st.ownItemCount(Scripture_Chapter_2) == 0)
				return null;
			if(st.ownItemCount(Scripture_Chapter_3) == 0)
				return null;
			if(st.ownItemCount(Scripture_Chapter_4) == 0)
				return null;
			if(st.ownItemCount(Cronos_Sigil) == 0)
				return null;
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Mirien)
		{
			if(st.ownItemCount(Miriens_1st_Sigil) > 0)
			{
				if(st.ownItemCount(Symbol_of_Sylvain) == 0)
			...
			if(st.ownItemCount(Miriens_2nd_Sigil) > 0)
				return st.ownItemCount(Symbol_of_Jurek) > 0 ? "magister_mirien_q0214_08.htm" : "magister_mirien_q0214_07.htm";
			if(st.ownItemCount(Miriens_Instruction) > 0)
			{
				if(st.getPlayer().getLevel() < 36)
			...
			if(st.ownItemCount(Miriens_3rd_Sigil) > 0)
			{
		...
		if(npcId == Sylvain)
		{
			if(st.ownItemCount(Miriens_1st_Sigil) > 0)
			{
				if(st.ownItemCount(High_Priests_Sigil) < 1)
					return st.ownItemCount(Symbol_of_Sylvain) > 0 ? "sylvain_q0214_05.htm" : "sylvain_q0214_01.htm";
				if(st.ownItemCount(Crystal_of_Purity1) < 1)
			...
			if(st.ownItemCount(Miriens_2nd_Sigil) > 0 || st.ownItemCount(Miriens_3rd_Sigil) > 0)
				return "sylvain_q0214_06.htm";
		}

		if(npcId == Lucas)
			if(st.ownItemCount(Miriens_1st_Sigil) > 0 && st.ownItemCount(High_Priests_Sigil) > 0)
			{
				if(st.ownItemCount(Marias_1st_Letter) > 0)
				{
				...
				if(st.ownItemCount(Lucillas_Handbag) > 0)
					return "lucas_q0214_02.htm";
				if(st.ownItemCount(Cretas_Painting1) > 0)
					return "lucas_q0214_02.htm";
				if(st.ownItemCount(Lucass_Letter) > 0)
					return "lucas_q0214_02.htm";
				if(st.ownItemCount(Cretas_Painting2) > 0)
					return "lucas_q0214_03.htm";
				if(st.ownItemCount(Cretas_Painting3) > 0)
					return st.ownItemCount(Brown_Scroll_Scrap) < 5 ? "lucas_q0214_05.htm" : "lucas_q0214_06.htm";
			}
			else
			{
				if(st.ownItemCount(Symbol_of_Sylvain) > 0)
				...
				if(st.ownItemCount(Miriens_3rd_Sigil) > 0)
					return "lucas_q0214_07.htm";
				if(st.ownItemCount(Crystal_of_Purity1) > 0)
					return "lucas_q0214_07.htm";
			}

		if(npcId == Valkon && st.ownItemCount(Triffs_Ring) > 0)
		{
			long Valkons_Request_count = st.ownItemCount(Valkons_Request);
			long Scripture_Chapter_2_count = st.ownItemCount(Scripture_Chapter_2);
			if(st.ownItemCount(Crystal_of_Purity2) == 0)
			{
		...
		if(npcId == Dieter)
		{
			if(st.ownItemCount(Miriens_3rd_Sigil) > 0 && st.ownItemCount(Cronos_Sigil) > 0)
			{
				if(st.ownItemCount(Cronos_Letter) > 0)
				...
				if(st.ownItemCount(Dieters_Diary) > 0)
				{
					if(st.ownItemCount(Dieters_Letter) > 0)
		...
		if(npcId == Jurek)
		{
			if(st.ownItemCount(Miriens_2nd_Sigil) > 0)
			{
				long Grand_Magisters_Sigil_count = st.ownItemCount(Grand_Magisters_Sigil);
				long Symbol_of_Jurek_count = st.ownItemCount(Symbol_of_Jurek);
				if(Grand_Magisters_Sigil_count == 0 && Symbol_of_Jurek_count == 0)
					return "jurek_q0214_01.htm";
				if(st.ownItemCount(Jureks_List) > 0)
				{
			...
			if(st.ownItemCount(Miriens_1st_Sigil) > 0 || st.ownItemCount(Miriens_3rd_Sigil) > 0)
				return "jurek_q0214_07.htm";
		}

		if(npcId == Edroc && st.ownItemCount(Dieters_Diary) > 0)
		{
			if(st.ownItemCount(Dieters_Letter) > 0)
				return "trader_edroc_q0214_01.htm";
			if(st.ownItemCount(Rauts_Letter_Envelope) > 0)
				return "trader_edroc_q0214_03.htm";
			if(st.ownItemCount(Strong_Liquor) > 0 || st.ownItemCount(Triffs_Ring) > 0)
				return "trader_edroc_q0214_04.htm";
		}

		if(npcId == Raut && st.ownItemCount(Dieters_Diary) > 0)
		{
			if(st.ownItemCount(Rauts_Letter_Envelope) > 0)
			...
			if(st.ownItemCount(Scripture_Chapter_1) > 0)
			{
				...
				if(st.ownItemCount(Triffs_Ring) > 0)
					return "warehouse_keeper_raut_q0214_05.htm";
			}
		}

		if(npcId == Poitan && st.ownItemCount(Triffs_Ring) > 0)
		{
			long Poitans_Notes_count = st.ownItemCount(Poitans_Notes);
			long Casians_List_count = st.ownItemCount(Casians_List);
			if(st.ownItemCount(Scripture_Chapter_4) == 0)
			{
		...
		if(npcId == Maria)
		{
			...
			if(st.ownItemCount(Symbol_of_Sylvain) > 0 || st.ownItemCount(Miriens_2nd_Sigil) > 0)
				return "marya_q0214_16.htm";
			if(st.ownItemCount(Miriens_3rd_Sigil) > 0)
			{
				if(st.ownItemCount(Valkons_Request) == 0)
		...
		if(npcId == Creta)
		{
			...
			if(st.ownItemCount(Miriens_2nd_Sigil) > 0)
				return "astrologer_creta_q0214_11.htm";
			if(st.ownItemCount(Miriens_3rd_Sigil) > 0)
				return st.ownItemCount(Dieters_Key) > 0 ? "astrologer_creta_q0214_12.htm" : "astrologer_creta_q0214_15.htm";
		}

		if(npcId == Cronos && st.ownItemCount(Miriens_3rd_Sigil) > 0)
		{
			if(st.ownItemCount(Cronos_Sigil) > 0)
			{
				if(st.ownItemCount(Scripture_Chapter_1) == 0)
			...
			return st.ownItemCount(Symbol_of_Cronos) > 0 ? "sage_cronos_q0214_15.htm" : "sage_cronos_q0214_01.htm";
		}

		if(npcId == Triff)
		{
			if(st.ownItemCount(Dieters_Diary) > 0 && st.ownItemCount(Scripture_Chapter_1) > 0 && st.ownItemCount(Strong_Liquor) > 0)
		...
		if(npcId == Casian && st.ownItemCount(Triffs_Ring) > 0)
		{
			long Casians_List_count = st.ownItemCount(Casians_List);
			if(st.ownItemCount(Poitans_Notes) > 0)
			{
				if(Casians_List_count > 0)
					return Check_cond29_items(st) ? "sage_kasian_q0214_06.htm" : "sage_kasian_q0214_05.htm";
				if(st.ownItemCount(Scripture_Chapter_1) > 0 && st.ownItemCount(Scripture_Chapter_2) > 0 && st.ownItemCount(Scripture_Chapter_3) > 0)
					return "sage_kasian_q0214_02.htm";
				st.setCond(27);
				return "sage_kasian_q0214_01.htm";
			}
			if(Casians_List_count == 0 && st.ownItemCount(Scripture_Chapter_1) > 0 && st.ownItemCount(Scripture_Chapter_2) > 0 && st.ownItemCount(Scripture_Chapter_3) > 0 && st.ownItemCount(Scripture_Chapter_4) > 0)
	...
	{
		if(st.ownItemCount(Monster_Eye_Destroyer_Skin) < 5)
			return false;
		if(st.ownItemCount(Shamans_Necklace) < 5)
			return false;
		if(st.ownItemCount(Shackles_Scalp) < 2)
			return false;
		return true;
	}
	...
	private static boolean Check_cond29_items(QuestState st)
	{
		...
		if(st.ownItemCount(Medusas_Blood) < 12)
			return false;
		if(st.ownItemCount(Fettered_Souls_Ichor) < 5)
			return false;
		if(st.ownItemCount(Enchanted_Gargoyles_Nail) < 5)
			return false;
		return true;
	}
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Grandis && st.ownItemCount(Miriens_3rd_Sigil) > 0 && st.ownItemCount(Cronos_Sigil) > 0 && st.ownItemCount(Triffs_Ring) > 0)
			st.rollAndGive(Scripture_Chapter_3, 1, 1, 1, 30);

		if(npcId == Leto_Lizardman_Warrior && st.ownItemCount(Miriens_1st_Sigil) > 0 && st.ownItemCount(High_Priests_Sigil) > 0 && st.ownItemCount(Cretas_Painting3) > 0)
			if(st.rollAndGive(Brown_Scroll_Scrap, 1, 1, 5, 50))
				st.setCond(12);

		if(npcId == Monster_Eye_Destroyer && st.ownItemCount(Miriens_2nd_Sigil) > 0 && st.ownItemCount(Grand_Magisters_Sigil) > 0 && st.ownItemCount(Jureks_List) > 0)
			if(st.rollAndGive(Monster_Eye_Destroyer_Skin, 1, 1, 5, 50) && Check_cond17_items(st))
				st.setCond(17);

		if(npcId == Breka_Orc_Shaman && st.ownItemCount(Miriens_2nd_Sigil) > 0 && st.ownItemCount(Grand_Magisters_Sigil) > 0 && st.ownItemCount(Jureks_List) > 0)
			if(st.rollAndGive(Shamans_Necklace, 1, 1, 5, 50) && Check_cond17_items(st))
				st.setCond(17);

		if(npcId == Shackle && st.ownItemCount(Miriens_2nd_Sigil) > 0 && st.ownItemCount(Grand_Magisters_Sigil) > 0 && st.ownItemCount(Jureks_List) > 0)
			if(st.rollAndGive(Shackles_Scalp, 1, 1, 2, 50) && Check_cond17_items(st))
				st.setCond(17);

		if(npcId == Ghoul && st.ownItemCount(Triffs_Ring) > 0 && st.ownItemCount(Poitans_Notes) > 0 && st.ownItemCount(Casians_List) > 0)
			if(st.rollAndGive(Ghouls_Skin, 1, 1, 10, 100) && Check_cond29_items(st))
				st.setCond(29);

		if(npcId == Medusa && st.ownItemCount(Triffs_Ring) > 0 && st.ownItemCount(Poitans_Notes) > 0 && st.ownItemCount(Casians_List) > 0)
			if(st.rollAndGive(Medusas_Blood, 1, 1, 12, 100) && Check_cond29_items(st))
				st.setCond(29);

		if(npcId == Fettered_Soul && st.ownItemCount(Triffs_Ring) > 0 && st.ownItemCount(Poitans_Notes) > 0 && st.ownItemCount(Casians_List) > 0)
			if(st.rollAndGive(Fettered_Souls_Ichor, 1, 1, 5, 100) && Check_cond29_items(st))
				st.setCond(29);

		if(npcId == Enchanted_Gargoyle && st.ownItemCount(Triffs_Ring) > 0 && st.ownItemCount(Poitans_Notes) > 0 && st.ownItemCount(Casians_List) > 0)
