...
public class _408_PathToElvenwizard extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("1"))
		{
			...
			else if(st.ownItemCount(ETERNITY_DIAMOND_ID) > 0)
		...
		{
			if(st.ownItemCount(MAGICAL_POWERS_RUBY_ID) > 0)
				htmltext = "rogellia_q0408_10.htm";
			else if(st.ownItemCount(MAGICAL_POWERS_RUBY_ID) < 1 && st.ownItemCount(FERTILITY_PERIDOT_ID) > 0)
			{
		...
		{
			if(st.ownItemCount(ROGELLIAS_LETTER_ID) > 0)
			{
		...
		{
			if(st.ownItemCount(PURE_AQUAMARINE_ID) > 0)
				htmltext = "rogellia_q0408_13.htm";
			else if(st.ownItemCount(PURE_AQUAMARINE_ID) < 1 && st.ownItemCount(FERTILITY_PERIDOT_ID) > 0)
			{
		...
		{
			if(st.ownItemCount(APPETIZING_APPLE_ID) > 0)
			{
			...
			if(st.ownItemCount(NOBILITY_AMETHYST_ID) > 0)
				htmltext = "rogellia_q0408_17.htm";
			else if(st.ownItemCount(NOBILITY_AMETHYST_ID) < 1 && st.ownItemCount(FERTILITY_PERIDOT_ID) > 0)
			{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == ROSELLA)
		{
			...
			else if(st.ownItemCount(CHARM_OF_GRAIN_ID) > 0)
			{
				if(st.ownItemCount(RED_DOWN_ID) < 5)
					htmltext = "rogellia_q0408_09.htm";
				else if(st.ownItemCount(RED_DOWN_ID) > 4)
					htmltext = "rogellia_q0408_25.htm";
				else if(st.ownItemCount(GOLD_LEAVES_ID) > 4)
					htmltext = "rogellia_q0408_26.htm";
			}
			else if(st.ownItemCount(APPETIZING_APPLE_ID) > 0)
				htmltext = "rogellia_q0408_15.htm";
			else if(st.ownItemCount(IMMORTAL_LOVE_ID) > 0)
				htmltext = "rogellia_q0408_19.htm";
			else if(st.ownItemCount(SAP_OF_WORLD_TREE_ID) > 0 && st.ownItemCount(GOLD_LEAVES_ID) < 5)
				htmltext = "rogellia_q0408_16.htm";
			else if(st.ownItemCount(LUCKY_POTPOURI_ID) > 0)
			{
				if(st.ownItemCount(AMETHYST_ID) < 2)
					htmltext = "rogellia_q0408_20.htm";
				else
					htmltext = "rogellia_q0408_27.htm";
			}
			else if(st.ownItemCount(ROGELLIAS_LETTER_ID) > 0)
				htmltext = "rogellia_q0408_08.htm";
			else if(st.ownItemCount(ROGELLIAS_LETTER_ID) < 1 && st.ownItemCount(APPETIZING_APPLE_ID) < 1 && st.ownItemCount(IMMORTAL_LOVE_ID) < 1 && st.ownItemCount(CHARM_OF_GRAIN_ID) < 1 && st.ownItemCount(SAP_OF_WORLD_TREE_ID) < 1 && st.ownItemCount(LUCKY_POTPOURI_ID) < 1 && st.ownItemCount(FERTILITY_PERIDOT_ID) > 0)
				if(st.ownItemCount(MAGICAL_POWERS_RUBY_ID) < 1 | st.ownItemCount(NOBILITY_AMETHYST_ID) < 1 | st.ownItemCount(PURE_AQUAMARINE_ID) < 1)
					htmltext = "rogellia_q0408_11.htm";
				else if(st.ownItemCount(MAGICAL_POWERS_RUBY_ID) > 0 && st.ownItemCount(NOBILITY_AMETHYST_ID) > 0 && st.ownItemCount(PURE_AQUAMARINE_ID) > 0)
				{
					st.takeItems(MAGICAL_POWERS_RUBY_ID, -1);
					st.takeItems(PURE_AQUAMARINE_ID, st.ownItemCount(PURE_AQUAMARINE_ID));
					st.takeItems(NOBILITY_AMETHYST_ID, st.ownItemCount(NOBILITY_AMETHYST_ID));
					st.takeItems(FERTILITY_PERIDOT_ID, st.ownItemCount(FERTILITY_PERIDOT_ID));
		...
		else if(npcId == THALIA && cond > 0)
		{
			...
			else if(st.ownItemCount(SAP_OF_WORLD_TREE_ID) > 0)
				if(st.ownItemCount(GOLD_LEAVES_ID) < 5)
			...
			if(st.ownItemCount(IMMORTAL_LOVE_ID) > 0)
			{
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		{
			if(cond > 0 && st.ownItemCount(CHARM_OF_GRAIN_ID) > 0 && st.ownItemCount(RED_DOWN_ID) < 5 && Rnd.chance(70))
			{
		...
		{
			if(cond > 0 && st.ownItemCount(SAP_OF_WORLD_TREE_ID) > 0 && st.ownItemCount(GOLD_LEAVES_ID) < 5 && Rnd.chance(40))
			{
			...
			if(cond > 0 && st.ownItemCount(LUCKY_POTPOURI_ID) > 0 && st.ownItemCount(AMETHYST_ID) < 2 && Rnd.chance(40))
			{
