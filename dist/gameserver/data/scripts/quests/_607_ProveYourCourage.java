...
public class _607_ProveYourCourage extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equals("quest_accept"))
		{
			...
			if(st.ownItemCount(HEAD_OF_SHADITH) >= 1)
			{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(cond == 0)
		{
			...
			{
				if(st.ownItemCount(MARK_OF_KETRA_ALLIANCE3) == 1 || st.ownItemCount(MARK_OF_KETRA_ALLIANCE4) == 1 || st.ownItemCount(MARK_OF_KETRA_ALLIANCE5) == 1)
		...
		else if(cond == 1 && st.ownItemCount(HEAD_OF_SHADITH) == 0)
			htmltext = "elder_kadun_zu_ketra_q0607_0106.htm";
		else if(cond == 2 && st.ownItemCount(HEAD_OF_SHADITH) >= 1)
