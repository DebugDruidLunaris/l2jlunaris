...
public class _627_HeartInSearchOfPower extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == M_NECROMANCER)
		{
			...
			else if(st.ownItemCount(GEM_OF_SUBMISSION) == 300)
				htmltext = "dark_necromancer_q0627_0105.htm";
			else if(st.ownItemCount(GEM_OF_SAINTS) > 0)
				htmltext = "dark_necromancer_q0627_0301.htm";
		}
		else if(npcId == ENFEUX && st.ownItemCount(SEAL_OF_LIGHT) > 0)
	...
	{
		long count = st.ownItemCount(GEM_OF_SUBMISSION);
