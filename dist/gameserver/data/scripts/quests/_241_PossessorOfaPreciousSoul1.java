...
public class _241_PossessorOfaPreciousSoul1 extends Quest implements ScriptFile
{
	...
	public _241_PossessorOfaPreciousSoul1()
	{
		...
		addQuestItem(new int[] { LEGENG_OF_SEVENTEEN, MALRUK_SUCCUBUS_CLAW, FADED_POETRY_BOOK, ECHO_CRYSTAL, MEDICINE, CRIMSON_MOSS });
	}
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == 31739)
		{
			...
			else if(cond == 4 && st.ownItemCount(LEGENG_OF_SEVENTEEN) >= 1)
				htmltext = "31739-03.htm";
			else if(cond < 8 && st.ownItemCount(ECHO_CRYSTAL) < 1)
				htmltext = "31739-04r.htm";
			else if(cond == 8 && st.ownItemCount(ECHO_CRYSTAL) == 1)
				htmltext = "31739-05.htm";
			else if(cond < 10 && st.ownItemCount(FADED_POETRY_BOOK) < 1)
		...
		else if(npcId == 30754)
		{
			...
			else if(cond == 3 && st.ownItemCount(LEGENG_OF_SEVENTEEN) < 1)
		...
		else if(npcId == 31042)
		{
			...
			else if(cond == 6 && st.ownItemCount(MALRUK_SUCCUBUS_CLAW) < 10)
				htmltext = "31042-02r.htm";
			else if(cond == 7 && st.ownItemCount(MALRUK_SUCCUBUS_CLAW) == 10)
				htmltext = "31042-03.htm";
			else if(cond == 8 && st.ownItemCount(ECHO_CRYSTAL) >= 1)
				htmltext = "31042-04r.htm";
			else if(cond == 8 && st.ownItemCount(ECHO_CRYSTAL) == 0)
			{
				st.giveItems(ECHO_CRYSTAL, 1);
				htmltext = "31042-04r.htm";
			}
		...
		else if(npcId == 31336)
		{
			...
			else if(cond == 14 && st.ownItemCount(CRIMSON_MOSS) < 5)
				htmltext = "31336-02r.htm";
			else if(cond == 15 && st.ownItemCount(CRIMSON_MOSS) >= 5)
				htmltext = "31336-03.htm";
			else if(cond == 16 && st.ownItemCount(MEDICINE) >= 1)
				htmltext = "31336-04r.htm";
		}
		else if(npcId == 31743)
		{
			if(cond == 16 && st.ownItemCount(MEDICINE) >= 1)
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(cond == 3)
		{
			if(npcId == 21154 && Rnd.chance(10))
				st.addSpawn(27113);
			else if(npcId == 27113 && st.ownItemCount(LEGENG_OF_SEVENTEEN) == 0)
			{
		...
		else if(cond == 6)
		{
			...
			{
				if(st.ownItemCount(MALRUK_SUCCUBUS_CLAW) <= 9)
					st.giveItems(MALRUK_SUCCUBUS_CLAW, 1);
				if(st.ownItemCount(MALRUK_SUCCUBUS_CLAW) == 10)
				{
			...
			{
				if(st.ownItemCount(CRIMSON_MOSS) <= 4)
					st.giveItems(CRIMSON_MOSS, 1);
				if(st.ownItemCount(CRIMSON_MOSS) == 5)
				{
					st.soundEffect(SOUND_MIDDLE);
					st.setCond(15);
				}
