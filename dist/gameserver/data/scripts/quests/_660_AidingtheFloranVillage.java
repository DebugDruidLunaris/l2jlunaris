...
public class _660_AidingtheFloranVillage extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		long EYES = st.ownItemCount(WATCHING_EYES);
		long SCALE = st.ownItemCount(DELU_LIZARDMAN_SCALE);
		long SHARD = st.ownItemCount(ROUGHLY_HEWN_ROCK_GOLEM_SHARD);
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == ALEX && cond == 1)
		{
			...
			if(st.ownItemCount(WATCHING_EYES) + st.ownItemCount(DELU_LIZARDMAN_SCALE) + st.ownItemCount(ROUGHLY_HEWN_ROCK_GOLEM_SHARD) == 0)
