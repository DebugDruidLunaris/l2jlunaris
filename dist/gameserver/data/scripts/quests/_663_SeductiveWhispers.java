...
public class _663_SeductiveWhispers extends Quest implements ScriptFile
{
	...
	private final static int[] Recipes_Weapon_B = { 4963, 4966, 4967, 4968, 5001, 5003, 5004, 5005, 5006, 5007 };
	private final static int[] Ingredients_Weapon_B = { 4101, 4107, 4108, 4109, 4115, 4117, 4118, 4119, 4120, 4121 };
	// Chances
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		long Spirit_Bead_Count = st.ownItemCount(Spirit_Bead);
		if(event.equalsIgnoreCase("30846_04.htm") && _state == CREATED)
		{
			st.setCond(1);
			st.setMemoState("round", "0");
			st.setState(STARTED);
		...
		else if(event.equalsIgnoreCase("30846_12.htm") && _state == STARTED)
		{
			...
			st.setMemoState("round", String.valueOf(next_round));
			return dialog;
		}
