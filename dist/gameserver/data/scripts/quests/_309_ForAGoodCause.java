...
public class _309_ForAGoodCause extends Quest implements ScriptFile
{
	...
	private static final int[] MoiraiRecipes = { 15777, 15780, 15783, 15786, 15789, 15790, 15812, 15813, 15814 };
	private static final int[] Moiraimaterials = { 15647, 15650, 15653, 15656, 15659, 15692, 15772, 15773, 15774 };
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			if(st.ownItemCount(MucrokianHide) >= 180)
			{
			...
			if(st.ownItemCount(MucrokianHide) >= 100)
			{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Atra)
			...
			else if(cond == 1)
			{
				...
				if(st.ownItemCount(MucrokianHide) == 0)
