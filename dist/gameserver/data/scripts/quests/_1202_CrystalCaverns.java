...
public class _1202_CrystalCaverns extends Quest implements ScriptFile
{
	...
	// Items
	private static final int pollution_crystal = 9690;
	private static final int limpid_crystal = 9697;
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == TEARS)
		{
			...
			st.giveItems(Rnd.chance(50) ? WHITE_SEED_OF_EVIL_SHARD : BLACK_SEED_OF_EVIL_SHARD, seedsCount);
			st.takeItems(pollution_crystal, 1);
			st.giveItems(limpid_crystal, 1);
		}
		return null;
	}
