...
public class _060_GoodWorksReward extends Quest implements ScriptFile
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("32487-02.htm") && cond == 1 && !IsPursuerSpawned())
		{
			...
			n.setRunning();
			n.getAI().notifyEvent(CtrlEvent.EVT_AGGRESSION, new Object[] { st.getPlayer(), 100000 });
			Functions.npcSay(n, NpcString.S1_I_MUST_KILL_YOU, st.getPlayer().getName());
		...
		{
			if(st.ownItemCount(Bloody_Cloth_Fragment) < 1)
		...
		{
			if(st.ownItemCount(Helvetias_Antidote) < 1)
	...
	public String onKill(NpcInstance npc, QuestState qs)
	{
		...
		if(qs.getState() == STARTED && qs.getCond() == 1)
		{
			if(Rnd.chance(50))
			{
				Functions.npcSay(npc, NpcString.YOU_HAVE_GOOD_LUCK);

				return null;
			}
			Functions.npcSay(npc, NpcString.YOU_ARE_STRONG);
			qs.setCond(2);
	...
	static
	{
		...
		marks.put("AW", new int[] { 2673, 3172, 2809 });
		marks.put("BD", new int[] { 2627, 3172, 2762 });
		marks.put("BH", new int[] { 2809, 3119, 3238 });
		marks.put("BS", new int[] { 2721, 2734, 2820 });
		marks.put("DA", new int[] { 2633, 2734, 3307 });
		marks.put("DT", new int[] { 2627, 3203, 3276 });
		marks.put("EE", new int[] { 2721, 3140, 2820 });
		marks.put("ES", new int[] { 2674, 3140, 3336 });
		marks.put("GL", new int[] { 2627, 2734, 2762 });
		marks.put("HK", new int[] { 2673, 2734, 3293 });
		marks.put("NM", new int[] { 2674, 2734, 3307 });
		marks.put("OL", new int[] { 2721, 3203, 3390 });
		marks.put("PA", new int[] { 2633, 2734, 2820 });
		marks.put("PP", new int[] { 2721, 2734, 2821 });
		marks.put("PR", new int[] { 2673, 3172, 3293 });
		marks.put("PS", new int[] { 2674, 3172, 3336 });
		marks.put("PW", new int[] { 2673, 3140, 2809 });
		marks.put("SC", new int[] { 2674, 2734, 2840 });
		marks.put("SE", new int[] { 2721, 3172, 2821 });
		marks.put("SH", new int[] { 2674, 3172, 2840 });
		marks.put("SK", new int[] { 2633, 3172, 3307 });
		marks.put("SP", new int[] { 2674, 3140, 2840 });
		marks.put("SR", new int[] { 2673, 3140, 3293 });
		marks.put("SS", new int[] { 2627, 3140, 2762 });
		marks.put("TH", new int[] { 2673, 2734, 2809 });
		marks.put("TK", new int[] { 2633, 3140, 2820 });
		marks.put("TR", new int[] { 2627, 3203, 2762 });
		marks.put("WA", new int[] { 2674, 2734, 3336 });
		marks.put("WC", new int[] { 2721, 3203, 2879 });
		marks.put("WL", new int[] { 2627, 2734, 3276 });
		marks.put("WS", new int[] { 2867, 3119, 3238 });
	}
}