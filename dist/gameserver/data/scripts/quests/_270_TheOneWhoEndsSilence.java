...
public class _270_TheOneWhoEndsSilence extends Quest implements ScriptFile
{
	...
	private static final int[] LowMobs = { 22791, 22790, 22793 };
	private static final int[] HighMobs = { 22794, 22795, 22797, 22798, 22799, 22800 };
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			if(st.ownItemCount(TatteredMonkClothes) < 1)
				htmltext = "greymore_q270_05.htm";
			else if(st.ownItemCount(TatteredMonkClothes) < 100)
		...
		{
			if(st.ownItemCount(TatteredMonkClothes) >= 100)
			{
		...
		{
			if(st.ownItemCount(TatteredMonkClothes) >= 200)
			{
		...
		{
			if(st.ownItemCount(TatteredMonkClothes) >= 300)
			{
		...
		{
			if(st.ownItemCount(TatteredMonkClothes) >= 400)
			{
		...
		{
			if(st.ownItemCount(TatteredMonkClothes) >= 500)
			{
