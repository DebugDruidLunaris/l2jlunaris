...
public class _293_TheHiddenVeins extends Quest implements ScriptFile
{
	// NPCs
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			if(st.ownItemCount(Torn_Map_Fragment) < 4)
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Filaur)
		{
			long Chrysolite_Ore_count = st.ownItemCount(Chrysolite_Ore);
			long Hidden_Ore_Map_count = st.ownItemCount(Hidden_Ore_Map);
			long reward = st.ownItemCount(Chrysolite_Ore) * 10 + st.ownItemCount(Hidden_Ore_Map) * 1000L;
			if(reward == 0)
