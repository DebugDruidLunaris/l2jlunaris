...
public class _277_GatekeepersOffering extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == 30576 && cond == 1 && st.ownItemCount(STARSTONE1_ID) < 20)
			htmltext = "gatekeeper_tamil_q0277_04.htm";
		else if(npcId == 30576 && cond == 2 && st.ownItemCount(STARSTONE1_ID) < 20)
			htmltext = "gatekeeper_tamil_q0277_04.htm";
		else if(npcId == 30576 && cond == 2 && st.ownItemCount(STARSTONE1_ID) >= 20)
		{
	...
	public String onKill(NpcInstance npc, QuestState st)
	{
		...
		if(st.ownItemCount(STARSTONE1_ID) >= 20)
			st.setCond(2);
		return null;
	}
}