...
public class _137_TempleChampionPart1 extends Quest implements ScriptFile
{
	...
	public String onTalk(NpcInstance npc, QuestState st)
	{
		...
		QuestState qs_134 = st.getPlayer().getQuestState(_134_TempleMissionary.class);
		QuestState qs_135 = st.getPlayer().getQuestState(_135_TempleExecutor.class);
		int GetMemoState = st.getInt("fallen_angel_1");
		int npcId = npc.getNpcId();
		int id = st.getState();
		...
		switch(id)
		{
			case CREATED:
				if(npcId == sylvain)
					if(qs_134 != null && qs_135 != null && qs_134.isCompleted() && qs_135.isCompleted())
					{
