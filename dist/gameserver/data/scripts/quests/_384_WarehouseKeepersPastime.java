...
public class _384_WarehouseKeepersPastime extends Quest implements ScriptFile
{
	...
	private final static int[][] Rewards_Win = { { 16, 1888, 1 },
			//Synthetic Cokes
			{ 32, 1887, 1 },
			//Varnish of Purity
			{ 50, 1894, 1 },
	...
	private final static int[][] Rewards_Win_Big = { { 50, 883, 1 },
			//Aquastone Ring
			{ 80, 951, 1 },
			//Scroll: Enchant Weapon (C)
			{ 98, 852, 1 },
	...
	private final static int[][] Rewards_Lose = { { 50, 4041, 1 },
			//Mold Hardener
			{ 80, 952, 1 },
			//Scroll: Enchant Armor (C)
			{ 98, 1892, 1 },
	...
	private final static int[][] Rewards_Lose_Big = { { 50, 951, 1 },
			//Scroll: Enchant Weapon (C)
			{ 80, 500, 1 },
			//Great Helmet
			{ 98, 2437, 2 },
