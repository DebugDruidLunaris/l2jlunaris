...
public class IsidoraInstance extends NpcInstance
{
	...
	public void showChatWindow(Player player, int val, Object... args)
	{
		if(player.getVarB("newbieService"))
			player.sendPacket(new NpcHtmlMessage(player, this, HtmCache.getInstance().getNotNull(HTML_OLD, player), val));
		else
			player.sendPacket(new NpcHtmlMessage(player, this, HtmCache.getInstance().getNotNull(HTML_NEW, player), val));
	}
	...
	public void onBypassFeedback(Player player, String command)
	{
		...
		NpcHtmlMessage reward = new NpcHtmlMessage(player, this);
