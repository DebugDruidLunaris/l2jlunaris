...
public class TheFallHarvest extends Functions implements ScriptFile, OnDeathListener, OnPlayerEnterListener
{
	...
	private static File multiSellFile = new File("data/xml/other/event/TheFallHarvest/31255.xml");
	...
	public void startEvent()
	{
		...
		if(SetActive("TheFallHarvest", true))
		{
			...
			player.sendMessage("Ивент сбор осеннего урожая стартовал.");
	...
	public void stopEvent()
	{
		...
		if(SetActive("TheFallHarvest", false))
		{
			...
			player.sendMessage("Ивент сбор осеннего урожая не стартовал.");
