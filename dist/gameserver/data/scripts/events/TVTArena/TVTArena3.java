...
public class TVTArena3 extends Functions implements ScriptFile, OnDeathListener, OnTeleportListener, OnPlayerExitListener
{
	...
	public class StartTask extends RunnableImpl
	{
		...
		{
			spawnEventManagers();
			Announcements.getInstance().announceToAll("Evento Iniciado - TVT Arena 3");
	...
	public class StopTask extends RunnableImpl
	{
		...
		public void runImpl()
		{
			...
			Announcements.getInstance().announceToAll("Evento Finalizado - TVT Arena 3");
	...
	public void startEvent()
	{
		...
		if(SetActive("TVTArena3", true))
		{
			spawnEventManagers();
			_log.info("Event: TVT Arena 3 started");
			Announcements.getInstance().announceToAll("Ивент - ТВТ Арена 3 стартовал");
		}
		else
	...
	public void stopEvent()
	{
		...
		if(SetActive("TVTArena3", false))
		{
			...
			stop();
			_log.info("Event: TVT Arena 3 stopped");
			Announcements.getInstance().announceToAll("Ивент - ТВТ Арена 3 окончен");
		}
		else
