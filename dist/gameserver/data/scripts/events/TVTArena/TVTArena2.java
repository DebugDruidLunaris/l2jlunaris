...
public class TVTArena2 extends Functions implements ScriptFile, OnDeathListener, OnTeleportListener, OnPlayerExitListener
{
	...
	public class StartTask extends RunnableImpl
	{
		...
		{
			spawnEventManagers();
			Announcements.getInstance().announceToAll("Evento Iniciado - TVT Arena 2");
	...
	public class StopTask extends RunnableImpl
	{
		...
		public void runImpl()
		{
			...
			Announcements.getInstance().announceToAll("Evento Finalizado - TVT Arena 2");
	...
	public void startEvent()
	{
		...
		if(SetActive("TVTArena2", true))
		{
			spawnEventManagers();
			_log.info("Event: TVT Arena 2 started");
			Announcements.getInstance().announceToAll("Ивент - ТВТ Арена 2 стартовал");
		}
		else
	...
	public void stopEvent()
	{
		...
		if(SetActive("TVTArena2", false))
		{
			...
			stop();
			_log.info("Event: TVT Arena 2 stopped");
			Announcements.getInstance().announceToAll("Ивент - ТВТ Арена 2 окончен");
		}
		else
