...
public class TVTArena5 extends Functions implements ScriptFile, OnDeathListener, OnTeleportListener, OnPlayerExitListener
{
	...
	public class StartTask extends RunnableImpl
	{
		...
		{
			spawnEventManagers();
			Announcements.getInstance().announceToAll("evento começou TVT Arena 5");
	...
	public class StopTask extends RunnableImpl
	{
		...
		public void runImpl()
		{
			...
			Announcements.getInstance().announceToAll("evento terminou TVT Arena 5");
	...
	public void startEvent()
	{
		...
		if(SetActive("TVTArena5", true))
		{
			spawnEventManagers();
			_log.info("Event: TVT Arena 5 started");
			Announcements.getInstance().announceToAll("Ивент - ТВТ Арена 5 стартовал");
		}
		else
	...
	public void stopEvent()
	{
		...
		if(SetActive("TVTArena5", false))
		{
			...
			stop();
			_log.info("Event: TVT Arena 5 stopped");
			Announcements.getInstance().announceToAll("Ивент - ТВТ Арена 5 окончен");
		}
		else
