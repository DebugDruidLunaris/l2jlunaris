...
//TODO Все текста Евента Переделать в Стринги
//TODO Расшырить конфиги
public class GvG extends Functions implements ScriptFile
{
	...
	public static final int[] everydayStartTime = { 20, 30, 00 }; // hh mm ss
	...
	public static void activateEvent()
	{
		if(!isActive() && canBeStarted())
		{
			...
			Announcements.getInstance().announceToAll("Регистрация на GvG турнир началась! Community Board(Alt+B) -> Ивенты -> GvG (регистрация группы, описание)");
	...
	public void addGroup()
	{
		...
		{
			player.sendMessage("GvG турнир не активен.");
			return;
		}
