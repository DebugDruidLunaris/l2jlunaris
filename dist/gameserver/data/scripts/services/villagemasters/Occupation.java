...
public class Occupation extends Functions
{
	public void onTalk30026()
	{
		...
		{
			show("Não Tenho nada para lhe dizer!", pl, npc);
			return;
		}
	...
	public void onChange30037(String[] args)
	{
		...
		if(newClass == 26 && pl.getClassId() == ClassId.elvenMage)
		{
		...
		else if(newClass == 29 && pl.getClassId() == ClassId.elvenMage)
		{
		...
		else if(newClass == 11 && pl.getClassId() == ClassId.mage)
		{
		...
		else if(newClass == 15 && pl.getClassId() == ClassId.mage)
		{
			...
			if(Level >= 20 && pl.getInventory().getItemByItemId(MARK_OF_FAITH_ID) != null)
			{
				...
				pl.setClassId(newClass, false, true);
				if(Config.SERVICES_ALLOW_CLASS_BONUS)
					switch(Config.SERVICES_CLASS_BONUS_ITEM_DAY)
					{
						case 10:
							Functions.addItem(pl, 15195, 1);
							break;
						case 30:
							Functions.addItem(pl, 15202, 1);
							break;
						case 90:
							Functions.addItem(pl, 16969, 1);
							break;
					}
				htmltext = "30.htm";
			}
		...
		if(newClass == 19 && classId == ClassId.elvenFighter)
		{
			...
			if(Level >= 20 && pl.getInventory().getItemByItemId(ELVEN_KNIGHT_BROOCH_ID) != null)
			{
				...
				if(Config.SERVICES_ALLOW_CLASS_BONUS)
					...
					{
						case 10:
							Functions.addItem(pl, 15194, 1);
							break;
						case 30:
							Functions.addItem(pl, 15201, 1);
							break;
						case 90:
							Functions.addItem(pl, 16968, 1);
							break;
					}
				htmltext = "21.htm";
			}
		...
		if(newClass == 22 && classId == ClassId.elvenFighter)
		{
			...
			if(Level >= 20 && pl.getInventory().getItemByItemId(REORIA_RECOMMENDATION_ID) != null)
			{
				...
				if(Config.SERVICES_ALLOW_CLASS_BONUS)
					...
					{
						case 10:
							Functions.addItem(pl, 15197, 1);
							break;
						case 30:
							Functions.addItem(pl, 15204, 1);
							break;
						case 90:
							Functions.addItem(pl, 16971, 1);
							break;
					}
				htmltext = "25.htm";
			}
		...
		if(newClass == 1 && classId == ClassId.fighter)
		{
			...
			if(Level >= 20 && pl.getInventory().getItemByItemId(MEDALLION_OF_WARRIOR_ID) != null)
			{
				...
				if(Config.SERVICES_ALLOW_CLASS_BONUS)
					...
					{
						case 10:
							Functions.addItem(pl, 15196, 1);
							break;
						case 30:
							Functions.addItem(pl, 15203, 1);
							break;
						case 90:
							Functions.addItem(pl, 16970, 1);
							break;
					}
				htmltext = "29.htm";
			}
	...
	public void onChange30511(String[] args)
	{
		...
		if(newClass == 55 && classId == ClassId.scavenger)
			...
			else
			{
				...
				pl.setClassId(newClass, false, true);
				if(Config.SERVICES_2_CLASS_CHANGE_REWARD_ENABLED)
					if(pl.isMageClass())
						for(int i = 0; i < Config.SERVICES_2_CLASS_MAGE_CHANGE_REWARD.length; i += 2)
							pl.getInventory().addItem(Config.SERVICES_2_CLASS_MAGE_CHANGE_REWARD[i], Config.SERVICES_2_CLASS_MAGE_CHANGE_REWARD[i + 1]);
					else
						for(int i = 0; i < Config.SERVICES_2_CLASS_FIGHTER_CHANGE_REWARD.length; i += 2)
							pl.getInventory().addItem(Config.SERVICES_2_CLASS_FIGHTER_CHANGE_REWARD[i], Config.SERVICES_2_CLASS_FIGHTER_CHANGE_REWARD[i + 1]);
				htmltext = "08.htm";
			}
	...
	public void onChange30070(String[] args)
	{
		...
		if(newClass == 26 && classId == ClassId.elvenMage)
		{
			if(Level <= 19 && pl.getInventory().getItemByItemId(ETERNITY_DIAMOND_ID) == null)
				htmltext = "15.htm";
			if(Level <= 19 && pl.getInventory().getItemByItemId(ETERNITY_DIAMOND_ID) != null)
		...
		else if(newClass == 29 && classId == ClassId.elvenMage)
		{
			if(Level <= 19 && pl.getInventory().getItemByItemId(LEAF_OF_ORACLE_ID) == null)
				htmltext = "19.htm";
			if(Level <= 19 && pl.getInventory().getItemByItemId(LEAF_OF_ORACLE_ID) != null)
		...
		else if(newClass == 11 && classId == ClassId.mage)
		{
			if(Level <= 19 && pl.getInventory().getItemByItemId(BEAD_OF_SEASON_ID) == null)
				htmltext = "23.htm";
			if(Level <= 19 && pl.getInventory().getItemByItemId(BEAD_OF_SEASON_ID) != null)
		...
		else if(newClass == 15 && classId == ClassId.mage)
		{
			if(Level <= 19 && pl.getInventory().getItemByItemId(MARK_OF_FAITH_ID) == null)
				htmltext = "27.htm";
			if(Level <= 19 && pl.getInventory().getItemByItemId(MARK_OF_FAITH_ID) != null)
	...
	public void onChange30498(String[] args)
	{
		...
		if(newClass == 54 && classId == ClassId.dwarvenFighter)
		{
	...
	public void onChange30499(String[] args)
	{
		...
		if(newClass == 56 && classId == ClassId.dwarvenFighter)
		{
	...
	public void onChange30512(String[] args)
	{
		...
		if(newClass == 57 && classId == ClassId.artisan)
			if(Level <= 39)
	...
	public void onChange30109(String[] args)
	{
		...
		if(newClass == 20 && classId == ClassId.elvenKnight)
			if(Level <= 39)
		...
		else if(newClass == 21 && classId == ClassId.elvenKnight)
			if(Level <= 39)
		...
		else if(newClass == 5 && classId == ClassId.knight)
			if(Level <= 39)
		...
		else if(newClass == 6 && classId == ClassId.knight)
			if(Level <= 39)
		...
		else if(newClass == 8 && classId == ClassId.rogue)
			if(Level <= 39)
		...
		else if(newClass == 9 && classId == ClassId.rogue)
			if(Level <= 39)
		...
		else if(newClass == 23 && classId == ClassId.elvenScout)
			if(Level <= 39)
		...
		else if(newClass == 24 && classId == ClassId.elvenScout)
			if(Level <= 39)
		...
		else if(newClass == 2 && classId == ClassId.warrior)
			if(Level <= 39)
		...
		else if(newClass == 3 && classId == ClassId.warrior)
			if(Level <= 39)
	...
	public void onChange30115(String[] args)
	{
		...
		if(newClass == 27 && classId == ClassId.elvenWizard)
			if(Level <= 39)
		...
		else if(newClass == 28 && classId == ClassId.elvenWizard)
			if(Level <= 39)
		...
		else if(newClass == 12 && classId == ClassId.wizard)
			if(Level <= 39)
		...
		else if(newClass == 13 && classId == ClassId.wizard)
			if(Level <= 39)
		...
		else if(newClass == 14 && classId == ClassId.wizard)
			if(Level <= 39)
	...
	public void onChange30120(String[] args)
	{
		...
		if(newClass == 30 || classId == ClassId.oracle)
			if(Level <= 39)
		...
		else if(newClass == 16 && classId == ClassId.cleric)
			if(Level <= 39)
		...
		else if(newClass == 17 && classId == ClassId.cleric)
			if(Level <= 39)
	...
	public void onChange30500(String[] args)
	{
		...
		if(newClass == 45 && classId == ClassId.orcFighter)
		{
			...
			if(Level >= 20 && pl.getInventory().getItemByItemId(MARK_OF_RAIDER_ID) != null)
			{
				...
				if(Config.SERVICES_ALLOW_CLASS_BONUS)
					...
					{
						case 10:
							Functions.addItem(pl, 15199, 1);
							break;
						case 30:
							Functions.addItem(pl, 15206, 1);
							break;
						case 90:
							Functions.addItem(pl, 16973, 1);
							break;
					}
				htmltext = "12.htm";
			}
		...
		else if(newClass == 47 && classId == ClassId.orcFighter)
		{
			...
			if(Level >= 20 && pl.getInventory().getItemByItemId(KHAVATARI_TOTEM_ID) != null)
			{
				...
				if(Config.SERVICES_ALLOW_CLASS_BONUS)
					...
					{
						case 10:
							Functions.addItem(pl, 15200, 1);
							break;
						case 30:
							Functions.addItem(pl, 15207, 1);
							break;
						case 90:
							Functions.addItem(pl, 16974, 1);
							break;
					}
				htmltext = "16.htm";
			}
		...
		else if(newClass == 50 && classId == ClassId.orcMage)
		{
	...
	public void onChange30290(String[] args)
	{
		...
		if(newClass == 32 && classId == ClassId.darkFighter)
		{
		...
		else if(newClass == 35 && classId == ClassId.darkFighter)
		{
		...
		else if(newClass == 39 && classId == ClassId.darkMage)
		{
		...
		else if(newClass == 42 && classId == ClassId.darkMage)
		{
	...
	public void onChange30513(String[] args)
	{
		...
		if(newClass == 48 && classId == ClassId.orcMonk)
			if(Level <= 39)
		...
		else if(newClass == 46 && classId == ClassId.orcRaider)
			if(Level <= 39)
		...
		else if(newClass == 51 && classId == ClassId.orcShaman)
			if(Level <= 39)
		...
		else if(newClass == 52 && classId == ClassId.orcShaman)
			if(Level <= 39)
	...
	public void onChange30474(String[] args)
	{
		...
		if(newClass == 33 && classId == ClassId.palusKnight)
			if(Level <= 39)
		...
		else if(newClass == 34 && classId == ClassId.palusKnight)
			if(Level <= 39)
		...
		else if(newClass == 43 && classId == ClassId.shillienOracle)
			if(Level <= 39)
		...
		else if(newClass == 36 && classId == ClassId.assassin)
			if(Level <= 39)
		...
		else if(newClass == 37 && classId == ClassId.assassin)
			if(Level <= 39)
		...
		else if(newClass == 40 && classId == ClassId.darkWizard)
			if(Level <= 39)
		...
		else if(newClass == 41 && classId == ClassId.darkWizard)
			if(Level <= 39)
	...
	public void onChange32145(String[] args)
	{
		...
		if(newClass == 126 && classId == ClassId.femaleSoldier)
			if(Level >= 20 && pl.getInventory().getItemByItemId(SteelrazorEvaluation) != null)
			{
				...
				if(Config.SERVICES_ALLOW_CLASS_BONUS)
					...
					{
						case 10:
							Functions.addItem(pl, 15198, 1);
							break;
						case 30:
							Functions.addItem(pl, 15205, 1);
							break;
						case 90:
							Functions.addItem(pl, 16972, 1);
							break;
					}
				htmltext = "03.htm";
			}
	...
	public void onChange32146(String[] args)
	{
		...
		if(newClass == 125 && classId == ClassId.maleSoldier)
	...
	public void onChange32199(String[] args)
	{
		...
		if(newClass == 130 && pl.getClassId() == ClassId.warder)
		{
		...
		else if(newClass == 129 && pl.getClassId() == ClassId.warder)
		{
		...
		else if(newClass == 127 && pl.getClassId() == ClassId.trooper)
		{
		...
		else if(newClass == 128 && pl.getClassId() == ClassId.trooper)
		{
			if(Level <= 39 && pl.getInventory().getItemByItemId(SB_Certificate) == null)
				htmltext = "16.htm";
			else if(Level <= 39 && pl.getInventory().getItemByItemId(SB_Certificate) != null)
