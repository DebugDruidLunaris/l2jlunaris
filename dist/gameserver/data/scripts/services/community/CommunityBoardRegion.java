...
public class CommunityBoardRegion implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onBypassCommand(Player player, String bypass)
	{
		...
		{
			String tpl = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/bbs_regiontpl.htm", player);
			...
			HashMap<Integer, String> tpls = Util.parseTemplate(HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/bbs_region_list.htm", player));
		...
		else if("bbsreglist".equals(cmd))
		{
			...
			String html = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/bbs_region_sellers.htm", player);
			...
			String tpl = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/bbs_region_stpl.htm", player);
		...
		else if("bbsregview".equals(cmd))
		{
			...
			String title = "-";
			String tpl = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/bbs_region_storetpl.htm", player);
			...
			String html = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/bbs_region_view.htm", player);
