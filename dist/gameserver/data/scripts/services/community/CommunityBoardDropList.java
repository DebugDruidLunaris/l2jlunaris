...
public class CommunityBoardDropList implements ScriptFile, ICommunityBoardHandler
{
	...
	public void onBypassCommand(Player activeChar, String command)
	{
		...
		{
			String content = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/wiki/rewards/list.htm", activeChar);
			ShowBoard.separateAndSend(content, activeChar);
		}
		else if(cmd.equalsIgnoreCase("_bbsdropid"))
		{
			String content = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/wiki/rewards/rewards.htm", activeChar);
			if(!val1.equals(""))
			{
				...
				result2.append(activeChar.getLanguage() == Language.RUSSIAN ? "Next Page" : "Next page");
		...
		else if(cmd.equalsIgnoreCase("_bbsdroppage"))
		{
			...
			String content = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/wiki/rewards/rewardspage.htm", activeChar);
			...
			if(strback != null)
			{
				...
				result.append("\" action=\"bypass _bbsdroppage ").append(backpage).append("\" width=200 height=29 back=\"L2UI_CT1.OlympiadWnd_DF_Watch_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Watch\"></center>");
				result.append("</td>");
				result.append("</tr>");
		...
		{
			String content = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/wiki/rewards/mobsid.htm", activeChar);
		...
		{
			String content = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/wiki/rewards/mobs.htm", activeChar);
			if(!val1.equals(""))
			{
				String str1 = null;
				...
				result2.append("\" action=\"bypass _bbsdroplist" + "\" width=200 height=29 back=\"L2UI_CT1.OlympiadWnd_DF_Back_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Back\"></center>");
				result2.append("</td>");
				result2.append("</tr>");
				result2.append("</table></center>");
		...
		else if(cmd.equalsIgnoreCase("_bbsdropnpcnamepage"))
		{
			...
			String content = HtmCache.getInstance().getNotNull("scripts/services/community/" + Config.BBS_FOLDER + "/wiki/rewards/mobspage.htm", activeChar);
		...
		else if(cmd.equalsIgnoreCase("_bbsrewards"))
		{
			...
			if(!val1.equals(""))
			{
				...
				result.append("<td WIDTH=690 align=center valign=top>");
				result.append("<center><button value=\"");
				result.append(activeChar.getLanguage() == Language.RUSSIAN ? "Next Page" : "Next page");
		...
		else if(cmd.equalsIgnoreCase("_bbsrewardspage"))
		{
			...
			result.append("<td WIDTH=690 align=center valign=top>");
			result.append("<center><button value=\"");
			result.append(activeChar.getLanguage() == Language.RUSSIAN ? "Voltar" : "Back");
			result.append("\" action=\"bypass _bbsdroplist" + "\" width=200 height=29 back=\"L2UI_CT1.OlympiadWnd_DF_Back_Down\" fore=\"L2UI_CT1.OlympiadWnd_DF_Back\"></center>");
			result.append("</td>");
			result.append("</tr>");
			result.append("</table></center>");
	...
	private void generateNpcList(Player player, int id)
	{
		...
		if(list.isEmpty() || list == null || list.size() == 0)
		{
			...
			result.append("<table width=690><tr><td width=690><center><font name=\"hs12\" color=\"FF0000\">Item não encontrado</font></center></td></tr></table><br>");
			result.append("<center><table width=690>");
			result.append("<tr>");
			result.append("<td WIDTH=690 align=center valign=top>");
			result.append("<center><button value=\"");
	...
	private void generateNpcList(Player player, String name)
	{
		...
		if(list.isEmpty() || list == null || list.size() == 0)
		{
			...
			result.append(player.getLanguage() == Language.RUSSIAN ? "<table width=690><tr><td width=690><center><font name=\"hs12\" color=\"FF0000\">Item não encontrado</font></center></td></tr></table><br>" : "<table width=690><tr><td width=690><center><font name=\"hs12\" color=\"FF0000\">Item not found</font></center></td></tr></table><br>");
			result.append("<center><table width=690>");
			result.append("<tr>");
			result.append("<td WIDTH=690 align=center valign=top>");
			result.append("<center><button value=\"");
	...
	private String generateDropListAll(Player player, int id)
	{
		...
		if(npc != null)
		{
			...
			if(npc.getTemplate().getRewardList(RewardType.NOT_RATED_NOT_GROUPED) != null && !npc.getTemplate().getRewardList(RewardType.NOT_RATED_NOT_GROUPED).isEmpty())
			{
				...
				result.append("<td WIDTH=690 align=center valign=top>");
				result.append("<center><button value=\"");
				result.append("Additional Premium");
	...
	private void generateDropListAll(Player player, String name)
	{
		...
		if(list2.isEmpty() || list2 == null || list2.size() == 0)
		{
			...
			result.append(player.getLanguage() == Language.RUSSIAN ? "<table width=690><tr><td width=690><center><font name=\"hs12\" color=\"FF0000\">Monstro foi encontrado</font></center></td></tr></table><br>" : "<table width=690><tr><td width=690><center><font name=\"hs12\" color=\"FF0000\">Monster not found</font></center></td></tr></table><br>");
			result.append("<center><table width=690>");
			result.append("<tr>");
			result.append("<td WIDTH=690 align=center valign=top>");
			result.append("<center><br><br><button value=\"");
	...
	public static void generateDropListContinue(Player player, NpcInstance npc, double mod)
	{
		...
		if(npc != null)
			for(RewardGroup g : npc.getTemplate().getRewardList(RewardType.NOT_RATED_GROUPED))
			{
				...
				result.append("<table><tr><td width=170><font color=\"a2a0a2\">Drop Percentage: </font><font color=\"b09979\">").append(pf.format(gchance / RewardList.MAX_CHANCE)).append("</font></td></tr><table>");
				...
				for(RewardData d : g.getItems())
				{
					...
					result.append("</td>");
					result.append("<td FIXWIDTH=671 align=left valign=top>");
					result.append("<font color=\"0099FF\">Item Name:</font> ").append(HtmlUtils.htmlItemName(d.getItemId())).append("<br1><font color=\"LEVEL\">Taxa de Drop:</font> ").append(pf.format(d.getChance() / RewardList.MAX_CHANCE)).append(" <font color=\"b09979\">[Min: ").append(Math.round(d.getMinDrop())).append(" | Max: ").append(Math.round(d.getMaxDrop())).append("]</font>");
					result.append("</td>");
					result.append("</tr>");
					result.append("</table>");
					result.append("<table border=0 cellspacing=0 cellpadding=0>");
					...
					if(count == 5)
					{
						...
						result.append("<table><tr><td width=170><font color=\"a2a0a2\">Drop Active Percentage: </font><font color=\"b09979\">").append(pf.format(gchance / RewardList.MAX_CHANCE)).append("</font></td></tr></table>");
					}
				}
			}
		page++;
		...
		if(npc != null)
			for(RewardGroup g : npc.getTemplate().getRewardList(RewardType.NOT_RATED_NOT_GROUPED))
			{
				...
				for(RewardData d : g.getItems())
				{
					...
					result.append("</td>");
					result.append("<td FIXWIDTH=671 align=left valign=top>");
					result.append("<font color=\"0099FF\">Item Name:</font> ").append(HtmlUtils.htmlItemName(d.getItemId())).append("<br1><font color=\"LEVEL\"> Taxa de Drop:</font> ").append(pf.format(d.getChance() / RewardList.MAX_CHANCE)).append(" <font color=\"b09979\">[Min: ").append(Math.round(d.getMaxDrop() * imult)).append(" | Max: ").append(Math.round(d.getMaxDrop() * imult)).append("]</font>");
					result.append("</td>");
					result.append("</tr>");
					result.append("</table>");
					result.append("<table border=0 cellspacing=0 cellpadding=0>");
					...
					if(count == 5)
					{
						...
						result.append("<table><tr><td><table width=270 border=0><tr><td><font color=\"aaccff\">List of Active Herbs:</font></td></tr></table></td></tr></table>");
					}
				}
			}
		page++;
	...
	public static void generateSpoilList(Player player, NpcInstance npc, double mod)
	{
		...
		int count = 0;
		int page = 0;
		result.append("<table><tr><td><table width=270 border=0><tr><td><font color=\"aaccff\">Active Spoil List:</font></td></tr></table></td></tr></table>");
		...
		if(npc != null)
			for(RewardGroup g : npc.getTemplate().getRewardList(RewardType.SWEEP))
			{
				...
				for(RewardData d : g.getItems())
				{
					...
					result.append("</td>");
					result.append("<td FIXWIDTH=671 align=left valign=top>");
					result.append("<font color=\"0099FF\"> Item Name:</font> ").append(HtmlUtils.htmlItemName(d.getItemId())).append("<br1><font color=\"LEVEL\">Taxa de Drop:</font> ").append(pf.format(d.getChance() / RewardList.MAX_CHANCE)).append(" <font color=\"b09979\">[Min: ").append(d.getMinDrop()).append(" | Max: ").append(Math.round(d.getMaxDrop() * imult)).append("]</font>");
					result.append("</td>");
					result.append("</tr>");
					result.append("</table>");
					result.append("<table border=0 cellspacing=0 cellpadding=0>");
					...
					if(count == 5)
					{
						...
						list3.put(page, result.toString());
						result = new StringBuilder();
						result.append("<table><tr><td><table width=270 border=0><tr><td><font color=\"aaccff\">Lista de espólios ativa:</font></td></tr></table></td></tr></table>");
